...
<link href='https://www.flaticon.com/free-icons/tiktok' title='tiktok icons'/> 
<b:skin><![CDATA[
/* 
...
<b:section class='navbar' id='navbar' maxwidgets='1' showaddelement='yes'>
  <b:widget id='HTML4' locked='false' title='Nhạc' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<iframe src="https://www.nhaccuatui.com/lh/background/pxboma3sPyIc" width="1" height="1" frameborder="0" allowfullscreen allow="autoplay"></iframe>]]></b:widget-setting>
    </b:widget-settings>
  ...
  <b:widget id='HTML3' locked='false' title='Nhạc nền' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<iframe scrolling="no" width=640 height=180 src=https://zingmp3.vn/embed/album/zuuai06c?start=true frameborder="0" allowfullscreen="true"/></iframe>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:widget id='HTML2' locked='false' title='Nhạc nền' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<iframe scrolling="no" width=640 height=180 src=https://zingmp3.vn/embed/album/zuuai06c?start=true frameborder="0" allowfullscreen="true"/></iframe>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  ...
  <b:widget id='HTML1' locked='false' title='Nhạc nền' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<iframe scrolling="no" width=640 height=180 src=https://zingmp3.vn/embed/album/zuuai06c?start=true frameborder="0" allowfullscreen="true"/></iframe>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
